...
public class CompanyRepEntity extends UserEntity {
    private String companyName;
    private String department;
    private String position;
    private boolean approved = false;
    private InternshipEntity[] internships = new InternshipEntity[5];
    private int internshipCount = 0;

    public CompanyRepEntity(String id, String name, String companyName, String department, String position, String email) {
        super(id, name, email);
    ...
    public void addLoadedInternship(InternshipEntity internship) {
    ...
    public void createInternship(String title, String desc, String level, String major, 
        ...
        InternshipEntity newInternship = new InternshipEntity(title, desc, level, major, openingDate, 
        ...
        CSVReaderControl.appendCSV("sample_internship_list.csv", csvLine);

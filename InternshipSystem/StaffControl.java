...
public class StaffControl {
    ...
    private CareerCentreStaffEntity[] staffList;
    private int staffCount;
    private CompanyRepEntity[] companyReps;
    private int repCount;
    private InternshipEntity[] internships;
    private StudentEntity[] students;
    private int studentCount;

    public StaffControl(CareerCentreStaffEntity[] staffList, int staffCount, CompanyRepEntity[] companyReps, 
                        int repCount, InternshipEntity[] internships, StudentEntity[] students, int studentCount) {

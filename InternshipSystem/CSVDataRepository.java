...
public class CSVDataRepository implements DataRepository {
    ...
    public void updateCompanyRepData(String filename, CompanyRep[] reps, int repCount) {
        try {
    ...
    public void updateInternshipData(String filename, Internship[] internships, int internshipCount) {
        try {
            FileWriter fw = new FileWriter(filename, false);
